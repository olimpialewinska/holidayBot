<template>
  <div
    class="flex flex-col gap-4 w-full min-w-full rounded-xl p-4 shadow-md dark:bg-zinc-800 dark:hover:bg-zinc-700 hover:bg-gray-100 transition-all lg:flex-row"
  >
